...
var hotlist=[]
var pagelist=[]
export default class SearchDongTai extends Component {
    constructor(props){
        super(props);
        // this.shit().bind(this)
        this.state={
    ...
    componentWillMount(){
        postFetch(API.SearchHot,{type:1},(result)=>{
        ...
        if(this.state.isStyle==false){
            contview=(<View><View style={styles.his}>
                    ...
                    <View style={comstyle.leftview}>
                        ...
                        <TouchableOpacity onPress={()=>{this.props.navigation.navigate('SearchDongHistory')}}>
    ...
    searchdong(){
        ...
        Storage.get('sear').then((taggs)=>{
            if(taggs==null){
                taggs = new Array();
            }
            taggs.push(hist)
            AsyncStorage.setItem('sear', JSON.stringify(taggs),);
        })

        postFetch(API.SearchDongTai,{forumPost:{content:this.state.text}},(result)=>{
                ...
                <View style={styles.item}>
                    ...
                    <View style={styles.you}>
                        ...
                        <View style={styles.kais}>
                            <TouchableOpacity onPress={()=>{alert(this.props)}}>
