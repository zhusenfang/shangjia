...
export default class ChargeRemaind extends Component{
    constructor(props){
        super(props)
        this.state={
            changePrice:'',
    ...
    zhifu(){
        ...
        if(this.state.payType===2){
            postFetch(API.ZhiFuBaoPay,{totalPrice:this.state.changePrice,pathType:'0',pathName:'微信支付'},(result)=>{
            ...
            postFetch(API.ZhiFuBaoPay,{totalPrice:this.state.changePrice,pathType:'1',pathName:'支付宝支付'},(result)=>{
