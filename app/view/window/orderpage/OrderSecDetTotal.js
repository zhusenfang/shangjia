...
import OrderSecDetails from './OrderSecDetails';
import OrderSecNews from './OrderSecNews'
// var comdtime=600;
var navigation=null
...
export default class OrderSecDetTotal extends Component {
    ...
    render(){
        ...
        return(<View style={{flex:1,flexDirection:'column',zIndex:100,backgroundColor:'#f9f9f9'}}>
            ...
            >
                ...
                <OrderSecDetails navigation={navigation}/>
                <OrderSecNews navigation={navigation}/>
