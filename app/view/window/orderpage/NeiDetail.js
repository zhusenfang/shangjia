...
export default class NeiDetail extends Component {
constructor(props){
    super(props)
    this.state={
      time:0,//订单时间
        ...
        deliverFee:'',
        orderid:'0909874849584849584948',
        orderPayType:'支付宝'
    }
}
    _androidBack = () => {
                ...
                <View style={styles.top}>
                 ...
                 <View style={[comstyle.item,{marginTop:20}]}>
                     <View style={comstyle.rightview}>
                         <Image source={require('../../../img/order/daodian.png')} style={comstyle.maleft}/>
                         <Text style={[styles.dao,{marginLeft:10}]}>到店-

                             {/*{this.state.type==0?'外送-':'到店'}*/}</Text>
                         <Text style={styles.dao}>{this.state.deliveryType==0?'有效期内':this.state.deliveryType==1?'预约':'自提'}</Text>
                     </View>
                 ...
                 <View style={[comstyle.item,{marginTop:20}]}>
                     <View style={comstyle.rightview}>
                         <Image source={require('../../../img/order/dingdang.png')}  style={comstyle.maleft}/>
             ...
             {/*<View style={styles.beizhu}>*/}
                 ...
                 <View style={styles.vies}>
                     ...
                     <View style={[comstyle.item]}>
                         <View style={comstyle.rightview}>
                             <Image source={require('../../../img/order/yonghu.png')}  style={comstyle.maleft}/>
