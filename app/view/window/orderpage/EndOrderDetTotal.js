...
import EndOrderDetails from './EndOrderDetails';
import EndOrderNews from './EndOrderNews'
var navigation=null
...
export default class EndOrderDetTotal extends Component {
    ...
    render(){
        ...
        return(<View style={{flex:1,flexDirection:'column',zIndex:100,backgroundColor:'#f9f9f9'}}>
            ...
            >
                ...
                <EndOrderDetails navigation={navigation}/>
                <EndOrderNews navigation={navigation}/>
